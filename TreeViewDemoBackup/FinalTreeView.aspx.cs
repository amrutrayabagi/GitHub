...
namespace TreeViewDemo
{
    public partial class FinalTreeView : System.Web.UI.Page
    {
        ...
        {
            //lstdataSource.Add(new Employee { EmployeeID = 1, EmployeeName = "John Smith", Designation = "COE", Department = "IT", Email = "", Location = "Bangalore", Company = "HCL", MgrEmployeeId = 0 });
        ...
        public void GetData()
        {
            ...
            //foreach(DataRow row as in dt){
            //lstdataSource.Add(new new Employee { EmployeeID = RowNotInTableException(, EmployeeName = "Jane Wilson", Designation = "Sr Vice President", Department = "IT", Email = "", Location = "Bangalore", Company = "HCL", MgrEmployeeId = 1 } );
            //}
